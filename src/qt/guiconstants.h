...
/* LapisLazuli GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "LapisLazuli"
#define QAPP_ORG_DOMAIN "lapislazuli.org"
#define QAPP_APP_NAME_DEFAULT "LapisLazuli-Qt"
#define QAPP_APP_NAME_TESTNET "LapisLazuli-Qt-testnet"
