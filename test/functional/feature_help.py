...
"""Verify that starting lapislazuli with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start lapislazuli with -? for help text")
        ...
        self.log.info("Start lapislazuli with -version for version information")
