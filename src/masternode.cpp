...
{
    if (nHeight >  750000) return 1000000 * COIN;
    if (nHeight >  650000) return 800000 * COIN;
    if (nHeight >  550000) return 650000 * COIN;
    if (nHeight >  450000) return 550000 * COIN;
    if (nHeight >  350000) return 450000 * COIN;
    if (nHeight >  250000) return 350000 * COIN;
    if (nHeight >  150000) return 250000 * COIN;
    if (nHeight >  115000) return 150000 * COIN;
    if (nHeight >   50000) return 150000 * COIN;
...
{
    if (nHeight >  750000) return 571 * COIN;
    if (nHeight >  650000) return 1142 * COIN;
    if (nHeight >  550000) return 914 * COIN;
    if (nHeight >  450000) return 1142 * COIN;
    if (nHeight >  350000) return 1428 * COIN;
    if (nHeight >  250000) return 1099 * COIN;
    if (nHeight >  150000) return 845 * COIN;
    ...
    if (nHeight >       0) return 15500000 * COIN;
...
{
    if (nHeight >  750000) return 400 * COIN;
    if (nHeight >  650000) return 800 * COIN;
    if (nHeight >  550000) return 640 * COIN;
    if (nHeight >  450000) return 800 * COIN;
    if (nHeight >  350000) return 1000 * COIN;
    if (nHeight >  250000) return 769 * COIN;
    if (nHeight >  150000) return 592 * COIN;
...
bool CMasternodeBroadcast::CheckInputsAndAdd(int& nDoS)
{
    ...
    // should be at least not earlier than block when 1000 LiLLi tx got MASTERNODE_MIN_CONFIRMATIONS
    uint256 hashBlock = UINT256_ZERO;
    CTransaction tx2;
    GetTransaction(vin.prevout.hash, tx2, hashBlock, true);
    BlockMap::iterator mi = mapBlockIndex.find(hashBlock);
    if (mi != mapBlockIndex.end() && (*mi).second) {
        CBlockIndex* pMNIndex = (*mi).second;                                                        // block for 1000 LiLLi tx -> 1 confirmation
