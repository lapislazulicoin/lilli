...
DefaultDirName={autopf}\LapisLazuli
...
OutputDir=.\output
OutputBaseFilename=LapisLazuliSetup
...
DefaultGroupName=LapisLazuli Core
...
[Files]
Source: ".\package\lapislazuli-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\LapisLazuli\LapisLazuli-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\LapisLazuli\LapisLazuli-Qt,strDataDir|{userappdata}\LapisLazuli\}');
  Result := True;
end;
