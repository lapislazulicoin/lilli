...
/** Utility functions used by the LapisLazuli Qt UI.
 */
namespace GUIUtil
{
...
// Render LiLLi addresses in monospace font
...
// Parse "lapislazuli:" URI into recipient object, return true on successful parsing
