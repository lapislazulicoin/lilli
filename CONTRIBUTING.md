Contributing to LapisLazuli Core
============================

The LapisLazuli Core project operates an open contributor model where anyone is
...
The following applies to code changes to the LapisLazuli Core project, and is not to be
confused with overall LapisLazuli Network Protocol consensus changes.

Whether a pull request is merged into LapisLazuli Core rests with the project merge
...
Patches that change LapisLazuli consensus rules are considerably more involved than
...
Where a patchset proposes to change the LapisLazuli consensus, it must have been
...
The project leader is the release manager for each LapisLazuli Core release.
