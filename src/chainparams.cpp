...
{
    const char* pszTimestamp = "The United Kingdom has the highest inflation in the G7, 22/06/2022, CNN";
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256S("00000258237e1bd4d90522e1c4309e530d6d8487cdb4f2e97b5b2363e27b35c3"))
    (1001, uint256S("3c03ada2b9f69af61fde5d066698628c7cb1325db0106a96a18b022ec0e3c4ed"))
    (1500, uint256S("8fbfbba54d2780ab86a502c4a42fe0683065568c2da67048601b926b3124c335"))
; 

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1643400030, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1655892322, 2177663, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000258237e1bd4d90522e1c4309e530d6d8487cdb4f2e97b5b2363e27b35c3"));
        ...
        consensus.nMaxMoneyOut = 12000000000 * COIN;
        ...
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 122);        // r
